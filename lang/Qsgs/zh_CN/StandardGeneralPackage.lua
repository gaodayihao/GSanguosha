...
★若对方只有一张【闪】或【杀】则即便使用（打出）了也无效",
	...
	["@wushuang-jink-1"] = "%src 拥有【无双】技能，您必须连续使用两张【闪】",
	["@wushuang-jink-2"] = "%src 拥有【无双】技能，你还需使用一张【闪】",
...
-- test
	...
	["shenjia"] = "神甲",
	[":shenjia"] = "<b>锁定技</b>，当你受到伤害时，你阻止该伤害，改为流失1点体力。",
	["#Shenjia"] = "%from 的技能【%arg2】阻止了本次伤害",
	["bumie"] = "不灭",
	[":bumie"] = "当你濒死时且正面朝上时，你可以选择一名角色，你回复其当前体力值的体力，其流失你所恢复的体力。若如此做，在操作完成后你讲你的武将牌翻面。",
	["@immortal"] = "不灭",
