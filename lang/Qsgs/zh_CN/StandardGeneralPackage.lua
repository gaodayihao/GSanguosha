...
-- effect
	...
	["$guanxing3"] = "此乃诸葛武侯之智(维)",
	["$guanxing4"] = "丞相,计若不成,维亦无悔!(维)",
	["$guicai"] = "天命？哈哈哈哈～",
	["$guidao1"] = "天下大势，为我所控",
	["$guidao2"] = "哼哼哼~",
	["$guose1"] = "请休息吧",
...
-- test
	...
	["nanhua"] = "南华老仙",
	["yihun"] = "移魂",
	[":yihun"] = "出牌阶段，你可以指定其他两名体力不同的角色，二者交换体力牌。若二者体力差值大于1，你回复1点体力。每阶段限一次。",
	["chushi"] = "出世",
	[":chushi"] = "<b>锁定技</b>，当你受到伤害时，你阻止该伤害，改为流失1点体力。",
	["#Chushi"] = "%from 的技能【%arg2】阻止了本次伤害",
	["shihun"] = "噬魂",
	[":shihun"] = "当你进入濒死状态时，若你的武将牌正面朝上，你可以选择一名角色并将你的武将牌翻面，你回复X点体力（X为目标角色当前的体力值），\
然后该角色失去Y点体力（Y=max（X，你的体力上限））。",
