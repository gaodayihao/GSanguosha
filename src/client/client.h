...
signals:
    ...
    void gongxin(const QList<int> &card_ids, bool enable_heart, bool enable_Spade);
    ...
    void skill_acquired(const ClientPlayer *player, const QString &skill_name, bool animation);
