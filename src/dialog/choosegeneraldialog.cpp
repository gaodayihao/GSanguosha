    ...
    :QDialog(parent)
{
    ...
    foreach(const General *general, generals){
        ...
        // special case, but I think do not need it from now on
    ...
    // role prompt
    QLabel *role_label = new QLabel(tr("You're the %1 seat of the %2").arg(Self->getSeat()).arg(Sanguosha->translate(Self->getRole())));
